Shader "Custom/OcclusionGreenToTransparent"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // Chroma Key: make pixels near the green key color fully transparent
                float diff = distance(finalColor.rgb, _ChromaKeyColor.rgb);
                if (diff < _ChromaThreshold)
                {
                    finalColor.a = 0;
                }
